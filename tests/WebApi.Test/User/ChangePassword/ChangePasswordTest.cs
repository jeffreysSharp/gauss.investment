...
{
    public class ChangePasswordTest : GaussInvestmentClassFixture
    {
        ...
        public async Task Error_New_Password_Empty(string culture)
        {
            ...
            var expectedMessage = ResourceMesssagesException.ResourceManager.GetString("PASSWORD_EMPTY", new CultureInfo(culture));
